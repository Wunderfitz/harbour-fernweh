...
void O1Flickr::verifyPin(const QString &pin)
{
    verifier_ = pin;
    exchangeToken();
}

void O1Flickr::onPinRequestError(QNetworkReply::NetworkError error)
{
...
void O1Flickr::onPinRequestFinished()
{
